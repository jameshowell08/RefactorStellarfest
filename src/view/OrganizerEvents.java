...
import observer.ValidationErrorObserver;

public class OrganizerEvents implements ValidationErrorObserver{
	...
	public OrganizerEvents(String OrganizerId, BorderPane root, Scene scene) {
		 ValidationErrorNotifier.getInstance().addObserver(this);
		sp = new ScrollPane();
		container = new BorderPane();
		eCon = new EventController();
		eoCon = new EventOrganizerController();
